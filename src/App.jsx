...
const Hero = () => (
  <section id="home" className="min-h-screen flex flex-col justify-center items-center text-center bg-bg-['0F2F2] px-4 pt-20">
    ...
    <h1 className="text-6xl md:text-7xl font-primary_font  max-w-4xl leading-tight font-semibold">
    ...
    <p className="max-w-3xl mx-auto font-primary_font font-semibold text-gray-700 text-xl mt-7 leading-relaxed">
    ...
    <div className="mt-10 flex w-full max-w-md shadow-lg rounded-xl relative">
       <input
            type="email"
            ...
            className="
              ...
              py-4 pl-4 pr-[260px] font-primary_font font-bold
          ...
          <button
            type="submit"
            className="
              absolute right-2 top-1/2 -translate-y-1/2 /* Position the button */
