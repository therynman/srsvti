...
//               <ul className="space-y-2">
//                 <li><a href="https://www.linkedin.com/company/srsvti/" className="hover:text-primary transition-colors">LinkedIn</a></li>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-20">
        <div className="flex flex-col md:flex-row justify-between gap-12 text-center md:text-left">
          ...
          <div className="max-w-md mx-auto md:mx-0">
            ...
            <div className="mt-8 flex flex-col sm:flex-row w-full p-1 rounded-lg bg-gray-900 border border-gray-700 relative text-sm gap-2">
  <input
    type="email"
